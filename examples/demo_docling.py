...
# Offset integrity: every mapped word's recorded span must slice back to
# exactly its own text. This is the invariant locate() depends on.
bad = [
...
# size used during processing - normalized coords don't care) and draw
# the boxes on it.
